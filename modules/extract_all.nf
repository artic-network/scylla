...
process extract_taxa_paired_reads {
    ...
    conda "bioconda::pyfastx=2.2.0 conda-forge::numpy=2.3.5 bioconda::htslib=1.20"
    container "community.wave.seqera.io/library/htslib_pyfastx_numpy:01e5d072aa220bef"
